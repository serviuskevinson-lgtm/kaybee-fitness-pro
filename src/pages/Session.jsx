  ...
  if (!workout) {
    return (
      <div className="min-h-screen bg-[#0a0a0f] text-white p-8 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-2xl font-bold mb-2">{t('no_active_session')}</h2>
        <p className="text-gray-400 mb-8 max-w-xs">{t('select_session_msg')}</p>
        <Link to="/exercises">
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 uppercase tracking-widest font-bold">
                        {exo.sets || 4} {t('sets')} • {exo.reps || 12} Reps
                      </p>
                    </div>
                  </div>
